...
//DONE: declare as Rest Controller
@RestController
...
public class CovidReporterController {
	...
	// DONE: place GET request mapping for path "countries" here.
	@GetMapping("countries")
	public List<String> getAllCountries() {
		//DONE: Call {@code DictionaryService.getAllCountries()} method to get all countries.
	...
	// DONE: place GET request mapping for path "reports" here.
	@GetMapping("reports")
	public List<ReportDto> getAllReports() {
		//DONE: Call {@code ReportService.getAllReports()} method to get reports list sorted by creation date descending.
	...
	// DONE: place POST request mapping for path "reports" here.
	@PostMapping("reports")
	public void createReport(
			//DONE: 1) map to Request Body.
			//DONE: 2) the input parameters must be validated.
			@RequestBody
			@Valid CreateReportParametersDto parameters
	) {
		//DONE: Call {@code ReportService.createReport(...)} method to create a new report.
